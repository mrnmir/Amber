...
NUM_BROADCAST_SLOTS = 2  # number of slots for nodes to respond to broadcast commands (e.g., send_id, send_data)
...
def run_simulation():
    print("=" * 80)
    print("6G IoT Broadcast Demo (3 nodes: WPT, WPT, Hybrid)")
    print("=" * 80)
...
def plot_results(sim):
    ...
    ax1.set_title("Broadcast Demo - RSSI Coverage Map")
    plt.tight_layout()
    ...
    fig3.suptitle("Broadcast - DER, Throughput and Outcome")
    # plt.tight_layout()
